...
$router->get('/grupos/new', 'App\\Controllers\\GruposController@formNew');
$router->post('/grupos/new', 'App\\Controllers\\GruposController@cadastrar');
$router->get('/grupos/edit/{id}', 'App\\Controllers\\GruposController@formEdit');
$router->post('/grupos/edit/{id}', 'App\\Controllers\\GruposController@editar');
$router->post('/grupos/delete/{id}', 'App\\Controllers\\GruposController@deletar');
